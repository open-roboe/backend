...
def pytest_configure(config):
    ...
    # Usage: add the decorator
    # @pytest.mark.heavy_network_use
    # to a test function you want to mark as heavy network use
    config.addinivalue_line("markers", "heavy_network_use: Test makes many network calls.")
